...
urlpatterns = [
    ...
    path('<slug:category>', views.agenda_list, name="list"),
    ...
    path('agenda/<slug:slug>', views.agenda_detail, name="detail"),
    path('agenda/<slug:slug>/import', include(("importer.urls", "home"), namespace='importer'))
    ]